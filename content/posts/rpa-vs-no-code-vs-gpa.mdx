...
That second failure is why brittleness became the defining complaint about business-built automation, and it is a solvable problem. It is solvable by putting the understanding into the tool. It is not solvable by simplifying the interface further, which is what most of the industry tried.
...
That band is not small. It is also the band both major RPA vendors have quietly stopped writing content for, because the person who does that work cannot sign a six-figure contract.
...
The automation journey is not a ladder where you start with no-code, graduate to RPA, and arrive somewhere final. Most companies of any size will run all three at once, on different processes, and that is the correct end state rather than a transitional mess.
