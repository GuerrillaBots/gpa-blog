...
The same property cuts both ways. A system that plans its own path can plan a different one tomorrow. For reading an unstructured invoice, that flexibility is the feature. For preparing the numbers a CFO signs, reproducibility is the entire requirement. Gartner's projection that 40% of agentic AI projects will be cancelled by the end of 2027 is not a statement that the technology is fake. It is what happens when a capability suited to ambiguous work gets sold into structured work.

None of that is a naming problem. The naming problem is separate, and the dates tell it better than any argument.

---

## Eighteen months of a category land grab, with dates

What follows is reconstructed from page publication dates, sitemap timestamps and press releases on the vendor's own site. It is a sequence, not an inference about intent.
...
That is not a failure of execution. The execution was excellent, and anyone trying to move a term through a market should study the 17 March 2025 scaffolding page in particular. It defined a new term by putting it in parallel grammar with two terms buyers already accepted, then explicitly refused the pick-one framing that would have threatened the installed base. It worked, and it still did not produce a category.
...
That fourth band is not a rounding error. It is the weekly reconciliation across three portals and one spreadsheet. The monthly MIS pull that touches four systems. The download, rename, check, upload loop that has taken two hours every Tuesday for three years. Individually too small to survive a business case. Collectively, most of the work.

A CoE rejecting those is not a CoE failing. It is a CoE prioritising correctly, every single time, which is exactly why the queue never clears. We published our version of the three-tier argument as [Robotic. Agentic. Guerrilla.](/blog/three-kinds-of-automation) on 21 July 2026, and the full comparison of who builds, who owns and what happens when it breaks is in [RPA vs no-code vs GPA](/blog/rpa-vs-no-code-vs-gpa).

---

## Where agents genuinely win

The attack above is on the category theater and the audience abandonment. It is not on the technology, and it would be dishonest to leave the impression that agentic AI is only marketing.
...
That last one is not a nice-to-have. Brittleness has been the defining complaint about UI automation for a decade, and reasoning about what a step was *for* rather than where the button *was* is a genuine answer to it. The industry deserves credit for that.
